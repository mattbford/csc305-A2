Shader "Unlit/islandsShader"
{
	Properties
	{
		...
		_Tex1("Texture 1", 2D) = "green" {}
		_Tex2("Texture 2", 2D) = "yellow" {}
		_Tex3("Texture 3", 2D) = "blue" {}
		_Thresholds("Height Threshold", vector) = (0.5,0.1,0,0)
					...
					//                UNITY_FOG_COORDS(1)
								...
								fixed4 frag(v2f i) : SV_Target
								{
									...
									*/
									...
									else if (i.height < _Thresholds.x) albedo = col1;
									else if (i.height < _Thresholds.y) albedo = col2;
									else albedo = col3;
